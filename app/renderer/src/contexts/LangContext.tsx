...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'nav.developer': { tr: 'Gelistirici', en: 'Developer' },
  'nav.devServers': { tr: 'Dev Sunucular', en: 'Dev Servers' },
  'nav.nodeModulesBulk': { tr: 'node_modules Toplu', en: 'node_modules Bulk' },
  'nav.dockerCleanup': { tr: 'Docker Temizlik', en: 'Docker Cleanup' },
  'nav.editorCleanup': { tr: 'Editor Orphan', en: 'Editor Orphan' },
  'nav.secretSweep': { tr: 'Secret Tarama', en: 'Secret Sweep' },
  'nav.vulnScan': { tr: 'Güvenlik Açıkları', en: 'Vulnerability Scan' },
  'nav.behavior': { tr: 'Davranış İzleme', en: 'Behavior Monitor' },
  'nav.processTree': { tr: 'Process Ağacı', en: 'Process Tree' },
  // Sidebar items
